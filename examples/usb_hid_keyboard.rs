...
//
// Pi 2/3 only. That on-board hub is the soldered-on LAN9514, behind the
// DWC2 controller. A Pi 4 has neither: its USB host is a VL805 xHCI
// behind PCIe, which this crate doesn't drive yet, so this builds for
// `bcm2711` and then finds an empty root port.
